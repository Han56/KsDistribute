 ...
 * 功能描述：
 * 通过Http GET 去读取数据
 * 通过Http PUT 写入数据，Encode the value as the request content when doing put operation
 * @create 2022/4/30 下午3:31
 */
public class MyHttpProxyExample {
    ...
    //类加载时 初始化参数
    public MyHttpProxyExample(Configuration configuration,int port) {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        MyHttpProxyExample proxyExample = new MyHttpProxyExample(configuration,45889);
        proxyExample.start();
        proxyExample.join();
    }
